        ...
        if (message.content.includes("https://legacyplayers.com")) {
            if (args[0] == 'mc') {
                embedLogs
                    ...
                    .setURL(`${args[1]}`)
                    .setThumbnail('https://phlow.de/images/webdesign/bild-seitenverhaeltnis-4-3.png')
            ...
            if (args[0] == 'ony') {
                embedLogs
                    ...
                    .setTitle("Onyxia")
                    .setURL(`${args[1]}`)
                    .setThumbnail('https://trendblog.euronics.de/wp-content/uploads/2017/01/Seitenverhaeltnis_16_9.jpg')
            ...
            if (args[0] == 'azuregos') {
                embedLogs
                    ...
                    .setTitle("Azuregos")
                    .setURL(`${args[1]}`)
                    .setThumbnail('https://trendblog.euronics.de/wp-content/uploads/2017/01/Seitenverhaeltnis_16_10.jpg')
